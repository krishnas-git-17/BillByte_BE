...
{
    /// <inheritdoc />
    public partial class AddKotSnapchatTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KotNo = table.Column<int>(type: "integer", nullable: false),
                    KotNumber = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "KotSnapshotItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    KotSnapshotId = table.Column<int>(type: "integer", nullable: false),
                    ItemName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Qty = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KotSnapshotItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KotSnapshotItems_KotSnapshots_KotSnapshotId",
                        column: x => x.KotSnapshotId,
                        principalTable: "KotSnapshots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KotSnapshotItems_KotSnapshotId",
                table: "KotSnapshotItems",
                column: "KotSnapshotId");

            migrationBuilder.CreateIndex(
                name: "IX_KotSnapshots_RestaurantId_BusinessDate_KotNo",
                table: "KotSnapshots",
                columns: new[] { "RestaurantId", "BusinessDate", "KotNo" },
                unique: true);
